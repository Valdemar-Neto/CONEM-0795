...
# Dados de aceleração (array de exemplo)
dados_aceleracao = np.random.rand(1000)  # Dados de aceleração aleatórios para demonstração

# Calculando a frequência fundamental
f0 = calcular_frequencia_fundamental(dados_aceleracao, taxa_amostragem)
